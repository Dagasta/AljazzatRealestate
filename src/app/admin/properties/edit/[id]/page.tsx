...
export default function EditPropertyPage() {
    ...
    const { properties, updateProperty, isLoading: contextLoading } = useProperties();
    ...
    useEffect(() => {
        if (!contextLoading && properties.length > 0) {
            ...
            if (property) {
                ...
                // If not found in context, maybe it's just not loaded yet or doesn't exist
                // For a specialized "Edit" page, we could also fetch directly from Supabase
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await updateProperty(formData as any);
        ...
        <div className="p-10 bg-[#f8fafc] min-h-screen">
            <div className="mb-12">
                ...
                <div className="flex items-center space-x-4">
                    <h1 className="text-5xl font-black text-primary tracking-tight">Edit <span className="text-secondary italic">Property</span></h1>
                    <span className="px-4 py-2 bg-secondary/10 text-secondary text-xs font-black rounded-full uppercase tracking-widest mt-2">{formData.id}</span>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-4 space-y-8">
                    ...
                    <button
                        ...
                        className="btn-premium w-full flex items-center justify-center space-x-3 py-6 shadow-2xl disabled:opacity-70"
                    >
                        {isSubmitting ? (
                            ...
                            <>
                                <Save size={20} />
                                <span className="text-xl font-black uppercase tracking-widest leading-none">Update Listing</span>
                            </>
                        )}
                    </button>
                </div>
